...
resource storageBlobReaderRoleDefinition 'Microsoft.Authorization/roleDefinitions@2022-04-01-preview' existing = {
  scope: subscription()
  name: '2a2b9908-6ea1-4ae2-8e65-a410df84e7d1'
}

resource keyVaultReaderRoleDefinition 'Microsoft.Authorization/roleDefinitions@2022-04-01-preview' existing = {
  scope: subscription()
